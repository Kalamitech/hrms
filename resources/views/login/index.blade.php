...
<head>
    ...
    <title> Login to Kalami HRMS </title>
                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                <div class="card-header border-0">
                                    <div class="card-title text-center">
                                        <img src="app-assets/images/logo/logo.png" style="width: 200px; height: auto" alt="KHRMS Logo">
                                    </div>
                                    ...
                                    <div class="card-body" style="padding-top: 0px;">
                                        ...
                                        <form class="form-horizontal" method="POST" action="{{ route('loginHandler') }}">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input name="email" type="text" class="form-control" id="user-name" placeholder="Your Email" required>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 col-12 text-center">
                                                    <button style="margin-bottom: 10px; border-radius: 30px;" type="submit" class="btn btn-outline-info btn-block"><i class="ft-unlock" ></i> Login</button>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-12 col-12 float-sm-left text-center"><a href="/recover-password" class="card-link">Forgot Password?</a></div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
