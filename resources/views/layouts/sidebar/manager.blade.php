        ...
        <div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
            <div class="main-menu-content">
                    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" style="border-radius: 30px;">
                        ...
                        <li class=" nav-item"><a href=""><i class="la la-users"></i><span class="menu-title">Departments</span></a>
                            <ul class="menu-content">
                                <li>
                                    <a class="menu-item" href="/admin/add-department">
                                        <span>Add Department</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="menu-item" href="/admin/department-listings">
                                        <span>Department Listings</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
