...
@section('content-body')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <h3 style="text-align: center; margin-bottom:25px; margin-top: 15px;">Total Leave List</h3>
    ...
    <div class="modal fade" id="leaveInfoModal" tabindex="-1" role="dialog" aria-labelledby="leaveInfoDetailsModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form" method="POST" action="/admin/total-leave-listings">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control required" id="leaveFromDate" min="2019-05-27" name="leaveFromDate" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control required" id="leaveToDate" min="2019-05-27" name="leaveToDate" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required"  id="leaveType" name="leaveType" readonly>
                                    <input type="hidden" class="form-control required"  id="leaveTypeID" name="leaveTypeID" readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required"  id="leaveReason" name="leaveReason" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required"  id="leaveRemarks" name="leaveRemarks">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="submit" name="approve" value='approve' class="btn btn-outline-success">Approve</button>
                    <button type="submit" name="reject" value='reject' class="btn btn-outline-danger">Reject</button>
                </div>
            </form>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $( ".leave-modal" ).click(function(){
            ...
            document.getElementById("leaveTypeID").value = leaveData[8];
