...
@section('content-body')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <h3 style="text-align: center; margin-bottom:25px; margin-top: 15px;">Role List</h3>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="/admin/edit-role/{{$role->id}}">Edit</a>
                                                <a class="dropdown-item" href="/admin/delete-role/{{$role->id}}">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
